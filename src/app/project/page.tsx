            ...
            <div className='lg:w-[80%] md:w-[95%] w-full md:px-0 px-3  h-auto flex flex-col lg:gap-16 md:gap-12 gap-8 justify-center items-center'>
                ...
                <div className='flex flex-col w-full h-auto gap-5'>
                    <div className='w-full h-auto flex justify-between gap-3'>
                        ...
                        {/* Image */}
                        <div className='w-[500px] h-[230px] rounded-3xl flex justify-center items-center'>
                            <Image src='/images/' alt="quote-icon" width={78} height={55} className="w-full h-full object-cover" />
                        </div>
                    </div>
                </div>
            </div>
